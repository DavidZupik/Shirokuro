...
public class MainMenu extends Stage {
    ...
    private void loadImages(){
        audioIMG = new ImageView(new Image("sk/zupik/shirokuro/Main/Styles_Images/Images/audio.png"));
        noAudioIMG = new ImageView(new Image("sk/zupik/shirokuro/Main/Styles_Images/Images/noaudio.png"));
